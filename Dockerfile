...
RUN yum install -y nginx php71w php71w-cli php71w-common php71w-pear php71w-devel php71w-opcache php71w-fpm php71w-pdo php71w-xml php71w-mysql php71w-pecl-apcu php71w-pecl-xdebug
